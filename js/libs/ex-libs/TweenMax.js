...
//---- GETTERS / SETTERS -------------------------------------------------------------------------------------------------------
    ...
    _gsScope._gsDefine("easing.Back", ["easing.Ease"], function (Ease) {
        ...
        _wrap("SmallBounce",
            _create("SmallBounceOut", function (p) {
                //if (p < 1 / 2.75) {
                //    return 6.5625 * p * p;
                //} else if (p < 2 / 2.75) {
                //    return 8.5625 * (p -= 1.5 / 2.75) * p + 0.85;
                //} else if (p < 2.5 / 2.75) {
                //    return 6.5625 * (p -= 2.25 / 2.75) * p + 0.9375;
                //}
                //return 6.5625 * (p -= 2.625 / 2.75) * p + 0.984375;
                //if (p < 1 / 2.75) {
                //    p = 6 * p * p;
                //} else if (p < 2 / 2.75) {
                //    p = 6 * (p -= 1.5 / 2.75) * p + 0.75;
                //} else if (p < 2.5 / 2.75) {
                //    p = 6 * (p -= 2.25 / 2.75) * p + 0.9375;
                //} else {
                //    p = 6 * (p -= 2.625 / 2.75) * p + 0.984375;
                //}
                //return p;
                var s = 1 - p;
                //   return 1 - function(p) {
...
return 1 - easeIn( 1 - p );
            ...
            _create("SmallBounceIn", function (p) {
                if ((p = 1 - p) < 1 / 2.75) {
                    return 1 - (7.5625 * p * p);
                } else if (p < 2 / 2.75) {
            ...
            _create("SmallBounceInOut", function (p) {
                var invert = (p < 0.5);
                if (invert) {
                    p = 1 - (p * 2);
                } else {
